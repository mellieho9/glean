  ...
  "required_tools": [
    {
      ...
      "usage_hint": "Use to verify place names, get full addresses, and retrieve coordinates for any location mentioned in the content"
    }
  ]
}
"""
